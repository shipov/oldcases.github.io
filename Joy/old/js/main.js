...
$(".widget_body_header_close").click(function(){
 ...
 $('#adress_phis a').on('click', function (e) {
  e.preventDefault()
  $(this).tab('show')
})
 $('#adress_jur a').on('click', function (e) {
  e.preventDefault()
  $(this).tab('show')
})
 $('#adress_mail a').on('click', function (e) {
  e.preventDefault()
  $(this).tab('show')
})

 $(window).on("load",function(){
    $(".main_wrapper, .stat-container, .setting_wrapper, .setting-menu, .help-Container").mCustomScrollbar({
        scrollInertia:320,
        setTop: '0',
        axis:"y",
